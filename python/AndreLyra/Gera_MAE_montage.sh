...
BASE_BIAS="/pesq/share/monan/monan_gam/precip_24h/MAE/${DATA_INI:0:4}${DATA_INI:4:2}/${DATA_INI}"

DIR_TRAB=$(pwd)
DIR_OUT="/pesq/share/monan/monan_gam/precip_24h/MAE/${DATA_INI:0:4}${DATA_INI:4:2}/${DATA_INI}/"
