...
# Diretorio de saida
txt_dir = f"/pesq/share/monan/monan_gam/precip_24h/Skill/Skill_txt_thr{int(THRESHOLD_MM)}mm/{anomes}/{data_ini_str}"
...
for lead in lead_times:
    ...
    out_dir = Path(
        f"/lustre/projetos/monan_gam/andre.lyra/NetCDFs/precip_24h/CONTINGENCIA/{data_ini_str}"
    )
