...
# Uso:
# ./Gera_bias_montage.sh 2025120100 120
...
BASE_MONAN="/pesq/share/monan/monan_gam/precip_24h/MONAN/${DATA_INI:0:4}${DATA_INI:4:2}/${DATA_INI}"
BASE_BIAS="/pesq/share/monan/monan_gam/precip_24h/Bias/${DATA_INI:0:4}${DATA_INI:4:2}/${DATA_INI}"

DIR_TRAB=$(pwd)
DIR_OUT="/pesq/share/monan/monan_gam/precip_24h/Bias/${DATA_INI:0:4}${DATA_INI:4:2}/${DATA_INI}/"
...
for prazo in $(seq 24 24 ${PRAZO_MAX}); do
    ...
    IMG_GPM="${BASE_BIAS}/diff_MONAN_GPM_${dom}_${PRAZO3}h.png"
    IMG_GSMAP=${BASE_BIAS}/"diff_MONAN_GSMAP_${dom}_${PRAZO3}h.png"
    IMG_MSWEP=${BASE_BIAS}/"diff_MONAN_MSWEP_${dom}_${PRAZO3}h.png"
    ...
    # Arquivo de saida
    OUT="Bias_MONAN_${dom}_${PRAZO3}.png"
