...
Usage:
    python monan_24h.py YEAR MONTH DIA HOUR LENGHT

Example:
    python monan_precip_24h.py 2025 12 01 00 120
...
for i in range(days):
    ...
    caminho_out = f"{OUTPUT_PATH}{args.YEAR}{args.MONTH}/{initial_date}/"
    ...
    out_path = f"{OUTPUT_PATH}{args.YEAR}{args.MONTH}/{initial_date}/"
    ...
    netcdf_path = Path(OUTPUT_PATH) / initial_date / file_name
